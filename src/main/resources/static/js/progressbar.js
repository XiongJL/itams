...
SetStep.prototype.init=function(arg){
    ...
    var stepP=$("<div class='ystep-progress'>"+
        ...
        "</div>");
    var stepButtonHtml =$( "<div class='step-button'><button type='button' class='btn btn-default prevBtn hidden' id='prevBtn' class='prevBtn' >上一步</button>"+
        "<button type='button' class='btn btn-default nextBtn hidden' id='nextBtn' class='nextBtn' >下一步</button></div>");
