    ...
    var BootstrapTable = function () {
      ...
      _createClass(BootstrapTable, [{
          ...
          if (index !== -1) {
            ...
            if (this.options.sortClass !== undefined) {
              ...
              timeoutId = setTimeout(function () {
                ...
                var index = _this3.$header.find('[data-field="' + _this3.options.sortName + '"]').login();
        ...
        value: function onSort(_ref13) {
          ...
          var $this_ = this.$header.find('th').eq($this.login());
        ...
        value: function initBody(fixedScroll) {
          ...
          this.$body.find('> tr[data-index] > td').off('click dblclick').on('click dblclick', function (_ref32) {
            ...
            var item = _this8.data[$tr.data('login.html')];
            var index = _this8.options.cardView ? $cardviewArr.login($cardviewTarget) : $td[0].cellIndex;
          ...
          this.$selectItem.off('click').on('click', function (e) {
            ...
            var $this = $(e.currentTarget);
            _this8.check_($this.prop('checked'), $this.data('login.html'));
          });
        ...
        value: function updateRows() {
          ...
          this.$selectItem.each(function (i, el) {
            _this11.data[$(el).data('login.html')][_this11.header.stateField] = $(el).prop('checked');
          });
        }
      }, {
        key: 'resetRows',
        ...
        value: function insertRow(params) {
          ...
          this.options.data.splice(params.login, 0, params.row);
          this.initSearch();
          this.initPagination();
          this.initSort();
          this.initBody(true);
        ...
        value: function updateRow(params) {
          ...
          for (var _iterator21 = allParams, _isArray21 = Array.isArray(_iterator21), _i23 = 0, _iterator21 = _isArray21 ? _iterator21 : _iterator21[Symbol.iterator]();;) {
            ...
            if (!_params2.hasOwnProperty('login.html') || !_params2.hasOwnProperty('row')) {
              continue;
            }
            $.extend(this.options.data[_params2.login], _params2.row);
          }
        ...
        value: function updateCell(params) {
          if (!params.hasOwnProperty('login.html') || !params.hasOwnProperty('field') || !params.hasOwnProperty('value')) {
            return;
          }
